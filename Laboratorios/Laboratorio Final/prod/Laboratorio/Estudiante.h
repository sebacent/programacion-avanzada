...
class Estudiante : public Persona {
  ...
  public:
    Estudiante(std::string _nombre, std::string _cedula, std::string _direccion, Date _fechaNacimiento, std::string _telefono, int _creditos, Carrera* _carrera );
    ~Estudiante();
    int getCreditos();
    ...
    Carrera* getCarrera();
    void setCarrera(Carrera* _carrera);
